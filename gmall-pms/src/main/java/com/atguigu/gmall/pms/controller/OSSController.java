...
public class OSSController {
    ...
    public Resp<Object> policy(){
        ...
        String accessId = "LTAI4FhofCpUF9VPUWgor5gx"; // 请填写您的AccessKeyId。
        String accessKey = "fjVSpotWJyMZyOLbbUR5nhUEktxALO"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-shanghai.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "scw-20190615yjh"; // 请填写您的 bucketname 。
